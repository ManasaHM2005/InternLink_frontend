...
export default function Register() {
    ...
    const handleSubmit = (e) => {
        ...
        localStorage.setItem('internlink_registered_users', JSON.stringify(registeredUsers))
                ...
                {step === 1 ? (
                    ...
                    <form onSubmit={handleSubmit} className="auth-form">
                        ...
                        <div className="auth-actions">
                            <button type="button" className="btn btn-secondary" onClick={() => { setStep(1); setError(''); setSuccess(''); }}>Back</button>
